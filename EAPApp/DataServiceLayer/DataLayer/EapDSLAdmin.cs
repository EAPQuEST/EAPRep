       ...
       // public static object DBHelper { get; private set; }
        ...
        public static DataSet GetCourseName(string collegeName)
        {
            ...
            try
            {
                ...
                // sql = "select course_name from course_details where course_id IN(SELECT  college_coures.courseid FROM college_coures WHERE collegeid ='" + courseName + "')";
        ...
        //public static DataSet GetCourseById(string collegeId)
        //{
        //    string sql = "";
        //    //string nestedsql;
        //    SqlConnection con = null;
        ...
        //        sql = "select course_name from course_details where course_id IN" +
        //            "(SELECT  college_coures.courseid FROM college_coures WHERE collegeid ='" + collegeId + "'))";
